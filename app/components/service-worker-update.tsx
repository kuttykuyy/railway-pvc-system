...
export default function ServiceWorkerUpdate() {
  ...
  return (
    <div className="fixed bottom-20 right-4 left-4 md:left-auto z-50 max-w-sm animate-in slide-in-from-bottom-4">
      <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 text-white rounded-2xl shadow-xl p-4 border border-emerald-500/30">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className="bg-white text-emerald-700 hover:bg-emerald-50 font-semibold text-xs h-8 rounded-xl"
              >
              ...
              <Button
                ...
                className="text-emerald-100 hover:text-white hover:bg-white/10 h-8 text-xs rounded-xl"
              >
                Later
              </Button>
            </div>
          ...
          <button
            onClick={() => setShowUpdate(false)}
            className="flex-shrink-0 text-emerald-200 hover:text-white p-1 rounded-lg hover:bg-white/10 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
