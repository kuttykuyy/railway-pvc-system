...
async function main() {
  ...
  const baseIndices = [
    ...
    // and steel on WPI mild steel per Cl.46A.9, where GCC-2022 uses PPAC diesel and JPC
    // rates. All four are filled by importing the 2011-12 workbook, which carries
    // Apr 2012 - Apr 2026 and so covers the base month and quarters of any such contract.
    // Base values below are the July 2021 published figures, read from that workbook.
    { name: 'WPI Fuel & Power', baseValue: 115.20, description: 'WPI Fuel & Power group (pre-2022 GCC fuel component)' },
    { name: 'WPI Steel Bright Bars', baseValue: 132.70, description: 'WPI MS Bright Bars (pre-2022 GCC Cl.46A.9(1) reinforcement)' },
    { name: 'WPI Steel Angles & Channels', baseValue: 134.40, description: 'WPI Angles, Channels, Sections (pre-2022 GCC Cl.46A.9(2))' },
    { name: 'WPI Steel Flat Products', baseValue: 156.30, description: 'WPI Mild Steel Flat products (pre-2022 GCC Cl.46A.9(3) plates)' },
