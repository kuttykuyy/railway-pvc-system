/**
 * Shared GST-invoice HTML generator used by the public, user, and admin invoice PDF
 * routes. All user-controlled fields are HTML-escaped (see `esc`) to prevent stored XSS.
 */
export function generateGstInvoiceHtml(invoiceRaw: any, user: any): string {
